...
if (isset($_SERVER['HTTP_HOST']) && ($_SERVER['HTTP_HOST'] == "localhost" || $_SERVER['HTTP_HOST'] == "127.0.0.1")) {
	...
	DEFINE('DB_DATABASE', "lead_tracking");
...
// $username1 = "newsbunch_bunch";
// $password1 = 'TU[f4ZFQPqz3';
// $dbname1 = "newsbunch_newsbunch";
	...
	DEFINE('DB_USER', "newsbunch_web");
	
	#	 Define For Database User Password  *	 Database Password	=   ''
	
	DEFINE('DB_PASS', '80BJSg]j^]&-');
	
	#	 Define For Database Name *	 Database Name	=  sdar
	
	DEFINE('DB_DATABASE', "newsbunch_web");
