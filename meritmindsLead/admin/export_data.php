...
try {
    switch ($report_type) {
        case 'all_students':
            exportAllStudents($conn);
            break;
        case 'application_status':
            exportApplicationStatus($conn, $date_from, $date_to);
            break;
        case 'document_submissions':
            exportDocumentSubmissions($conn, $date_from, $date_to);
            break;
        case 'university_applications':
            exportUniversityApplications($conn, $date_from, $date_to);
            break;
        case 'fee_status':
            exportFeeStatus($conn, $date_from, $date_to);
            break;
        default:
            exportAllStudents($conn);
    }
...
function exportAllStudents($conn) {
...
function exportApplicationStatus($conn, $date_from, $date_to) {
...
function exportDocumentSubmissions($conn, $date_from, $date_to) {
...
function exportUniversityApplications($conn, $date_from, $date_to) {
...
function exportFeeStatus($conn, $date_from, $date_to) {
